...
class Base64MapperTest {
    ...
    private Base64Mapper mapper;

    @BeforeEach
    void setUp() throws Exception {
        Constructor<Base64Mapper> constructor = Base64Mapper.class.getDeclaredConstructor();
    ...
    void shouldConvertToBytes() {
        ...
        byte[] result = Base64Mapper.toBytes(input);
    ...
    void shouldReturnNullForToBytes() {
        assertNull(Base64Mapper.toBytes(null));
    }
    ...
    void shouldConvertToBase64() {
        ...
        String result = Base64Mapper.toBase64(input);
    ...
    void shouldReturnNullForToBase64() {
        assertNull(Base64Mapper.toBase64(null));
    }
}